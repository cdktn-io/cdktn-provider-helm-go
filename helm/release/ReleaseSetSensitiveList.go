...
func (j *jsiiProxy_ReleaseSetSensitiveList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewReleaseSetSensitiveList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ReleaseSetSensitiveList {
	_init_.Initialize()
...
func NewReleaseSetSensitiveList_Override(r ReleaseSetSensitiveList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ReleaseSetSensitiveList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ReleaseSetSensitiveList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ReleaseSetSensitiveList) Resolve(context cdktn.IResolveContext) interface{} {
