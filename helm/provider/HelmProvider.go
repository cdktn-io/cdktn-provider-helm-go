...
import (
	...
	"github.com/cdktn-io/cdktn-provider-helm-go/helm/v15/provider/internal"
...
func (h *jsiiProxy_HelmProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (h *jsiiProxy_HelmProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
