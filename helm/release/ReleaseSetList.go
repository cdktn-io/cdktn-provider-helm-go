...
func (j *jsiiProxy_ReleaseSetList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewReleaseSetList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ReleaseSetList {
	_init_.Initialize()
...
func NewReleaseSetList_Override(r ReleaseSetList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ReleaseSetList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (r *jsiiProxy_ReleaseSetList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (r *jsiiProxy_ReleaseSetList) Resolve(context cdktn.IResolveContext) interface{} {
